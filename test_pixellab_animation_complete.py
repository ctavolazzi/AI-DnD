#!/usr/bin/env python3
"""
PixelLab Animation Test - Complete
Test character animation generation with all required parameters
"""
    ...
    try:
        ...
        try:
            animation_response = client.animate_with_text(
                description="fantasy warrior with sword",
                negative_text="blurry, low quality, distorted",  # Add negative text
                action="walk",
